...
difficulty: "beginner"
order: 2
description: "Learn the A natural minor scale — the relative minor of C major."
layout: layout.njk
tags: lessons
---
...
The A natural minor scale is the relative minor of C major. It uses the same seven notes: **A, B, C, D, E, F, G** — but starts on A instead of C.
...
Natural minor scales follow this interval pattern:
...
Every major key has a relative minor that shares the same key signature. A minor is the relative minor of C major — both use only the white keys on the piano. The difference is the **tonal center**: in A minor, the melody and chords resolve to A, not C.

### Practice

Play through the A natural minor scale exercises below. Notice how the overall sound feels more melancholic compared to C major, even though they share the same notes.
...
<script>
(function () {
    var LESSON_NOTES = {% lessonNotes 'a-minor' %};
    var trainer = null;
