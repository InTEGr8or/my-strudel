...
assert.strictEqual(page.includes('notes="C4"'), true, 'first player is a C');
...
const thisC = page.indexOf('This is a <strong>C</strong>');
const playerIdx = page.indexOf('<staff-player notes="C4"');
const wordsIdx = page.indexOf('id="the-words"');
assert.ok(playIdx < thisC && thisC < playerIdx && playerIdx < wordsIdx, 'press-C prompt and player sit at the end of the first section');
